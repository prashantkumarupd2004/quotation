...
/**
 * Group 7 — compliance and money-collection guides. These cover the questions
...
export const blogPosts7: BlogPost[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'No. Input tax credit requires a valid tax invoice or debit note. If a supplier sends you only a proforma, ask for the tax invoice once the goods or services are delivered — your credit depends on it appearing in your GSTR-2B.',
      },
      {
      ...
      },
      {
        ...
        a: 'A separate one — PI- or PRO- prefixed. Mixing proformas into your tax invoice series breaks the consecutive numbering that GST requires and creates gaps that are hard to explain later.',
      },
      {
...

  {
    ...
    metaDescription:
      'The correct payment receipt format for Indian businesses — mandatory details, cash receipt limits under Section 269ST, advance receipt vouchers under GST, revenue stamp rules and a free receipt maker.',
    keywords: [
    ...
    category: 'Payments',
    excerpt:
      'Most payment disputes are not about whether money was owed — they are about whether it was paid. A proper receipt ends that argument before it starts.',
    intro:
      'A receipt is the least glamorous document your business produces and the one you will be most grateful for. Customers forget payments. Staff leave with cash-collection records in their heads. Bank statements show a transfer but not which of four pending bills it settled. Every one of those situations becomes a two-hour argument without a receipt and a thirty-second lookup with one. There are also hard rules attached — cash limits under the Income Tax Act, receipt vouchers under GST, and stamp requirements that still surprise people. This guide covers the format, the law and the habits.',
    sections: [
      {
        heading: 'What belongs on a payment receipt',
        body: 'A receipt has one job: prove that a specific person paid a specific amount to a specific business on a specific date, against a specific bill. Every field follows from that. You need a receipt number and date, your business name and address, the payer’s name, the amount in figures and in words, the payment mode (cash, UPI, NEFT, cheque, card), a reference for that mode — UTR number, cheque number, UPI transaction ID — and the invoice or bill number the payment is being applied to.\n\nTwo fields do disproportionate work. Linking the receipt to an invoice number is what stops the "which bill did that ₹50,000 settle?" conversation. And recording the balance still outstanding after this payment turns your receipts into a running ledger the customer has already acknowledged.',
        bullets: [
          ...
          'Payment mode plus its reference — UTR, cheque number or UPI ID',
          'Balance outstanding after this payment',
          'Signature of the person receiving the money',
        ],
      },
      {
        heading: 'Cash receipts and the ₹2 lakh limit you must not cross',
        body: 'Section 269ST of the Income Tax Act prohibits receiving ₹2,00,000 or more in cash from a single person in a single day, in respect of a single transaction, or in respect of transactions relating to one event or occasion. The penalty under Section 271DD falls on the receiver and equals the amount received. Not a percentage of it — the whole amount.\n\nThe rule catches people who think splitting helps. Taking ₹2.5 lakh as five payments of ₹50,000 across five days against one bill still relates to a single transaction, and it is still a violation. If a customer wants to pay a large amount in cash, the answer is to route it through the bank. Your receipt should always record the mode honestly, because a receipt that says "cash" for a bank transfer is a document you will regret.',
      },
      {
        heading: 'Advance payments and the GST receipt voucher',
        body: 'When you take money before supplying, GST law asks for a receipt voucher rather than an ordinary receipt. It must carry your name, address and GSTIN; a serial number; the date; the payer’s details; a description of the goods or services; the amount received; the rate and amount of tax; the place of supply for inter-state transactions; and whether tax is payable on reverse charge.\n\nIf the rate or the nature of supply is not known when the advance arrives, the rules provide defaults — treat the rate as 18% and, where the supply type is unclear, treat it as inter-state. When the deal is later completed, the advance is adjusted against the tax invoice. If the deal falls through and you refund the advance, issue a refund voucher referencing the original receipt voucher.',
      },
      {
        heading: 'Revenue stamps, signatures and rent receipts',
        body: 'The old rule still applies: a receipt for cash exceeding ₹5,000 requires a one-rupee revenue stamp affixed and signed across under the Indian Stamp Act. It is widely ignored and rarely enforced, but it matters in exactly the situation where the receipt matters — when the document is produced as evidence in a dispute. Stamps are not required for payments made by cheque or electronic transfer.\n\nRent receipts have their own quirk because employees submit them for HRA exemption. A valid rent receipt shows the tenant’s name, the landlord’s name and address, the rent amount and period, the property address, the payment mode and the landlord’s signature. Where annual rent exceeds ₹1,00,000, the employee’s employer will ask for the landlord’s PAN. Where monthly rent crosses ₹50,000, the tenant must deduct 5% TDS under Section 194-IB.',
      },
      {
        heading: 'Receipt numbering and the habits that keep records clean',
        body: 'Use one continuous series per financial year, prefixed so it cannot collide with invoices — REC-2026-0001. Never skip, never reuse, and if a receipt is spoiled, mark it cancelled and keep the copy. Auditors read gaps as missing income, and the burden of explaining a gap is entirely yours.\n\nThe operational habits matter as much as the format. Issue the receipt the same day the money arrives, not at month end. Send it to the customer immediately — a WhatsApp or email copy is now the norm and it prevents disputes better than a carbon copy in a book nobody looks at. Where staff collect payments in the field, insist that the customer receives a numbered receipt at the point of collection; unreceipted collection is how cash goes missing in small businesses. And reconcile receipts against your bank statement weekly rather than monthly, while you can still remember what an unexplained credit was for.',
      },
      {
        heading: 'Making receipts in seconds instead of minutes',
        body: 'A free payment receipt generator handles the mechanical parts — sequential numbering, amount in words, mode-specific reference fields, the invoice link and the running balance — and outputs a clean PDF with your logo and signature that you can send on WhatsApp before the customer has left. For advance payments, switch on the GST fields so the document doubles as a compliant receipt voucher. The point is not the aesthetics. It is that a receipt which takes ten seconds to produce actually gets produced every time, and a receipt book that lives in a drawer does not.',
      },
    ],
    faqs: [
      {
      ...
      {
        q: 'Can I accept ₹3 lakh in cash if the customer insists?',
        a: 'No. Section 269ST makes the receiver liable for a penalty equal to the entire amount received. Splitting it across days or bills relating to the same transaction does not help. Ask for a bank transfer or UPI for anything approaching ₹2 lakh.',
      },
      {
        q: 'How long should I keep payment receipts?',
        a: 'Keep them with your other books of account — at least six years from the end of the relevant assessment year for income tax purposes, and 72 months from the due date of the annual return for GST records. Digital copies are acceptable and are easier to preserve than thermal-printed slips, which fade.',
      },
    ],
...

  {
    ...
    metaDescription:
      'A practical system for recovering overdue payments in India — the MSME 45-day rule and Section 43B(h), interest you are entitled to, MSME Samadhaan filing, follow-up message templates and when to send a legal notice.',
    keywords: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'A written agreement cannot extend the payment period beyond 45 days for a registered micro or small enterprise — any term doing so is void to that extent under Section 15. The statutory interest therefore runs from day 46 regardless of what the contract says.',
      },
      {
        q: 'Is Udyam registration mandatory to use MSME Samadhaan?',
        a: 'Yes. The portal requires a valid Udyam Registration Number, and the buyer’s obligation under the MSMED Act applies to registered enterprises. Registration is free and online, so if you sell B2B and are not registered, do it before you need it.',
      },
      {
      ...
      },
      {
        ...
        a: 'Keep the clause in your terms and invoke it selectively. Having the clause gives you a legitimate escalation step, and mentioning it factually often prompts payment. Actually raising an interest debit note is a relationship decision — reserve it for accounts you are prepared to lose.',
      },
    ],
...

  {
    ...
    metaDescription:
      'When to issue a bill of supply instead of a tax invoice — composition dealers, exempt and nil-rated supplies, the mandatory declaration, format differences, ITC impact and how to bill correctly.',
    keywords: [
      'bill of supply',
    ...
    category: 'GST & Tax',
    excerpt:
      'If you are a composition dealer or you sell exempt goods, issuing a tax invoice is not just wrong — it can make you liable for tax you never collected.',
    intro:
...

  {
    ...
    metaDescription:
      'A plain-English guide to e-way bills — when the ₹50,000 threshold applies, who generates it, Part A vs Part B, validity by distance, extension, cancellation, exemptions and penalties for moving goods without one.',
    keywords: [
      'e way bill rules',
      'e way bill limit',
      'e way bill validity',
    ...
    intro:
      'The e-way bill is the GST system’s way of knowing that goods are moving before they arrive anywhere. For anyone who dispatches material — a trader sending stock to a customer, a fabricator sending components to a job worker, a shop moving inventory to a second branch — it is a routine step that becomes a serious problem exactly once, when a vehicle is stopped and the paperwork does not hold up. The rules are not complicated, but they are precise: thresholds, who generates what, two separate parts, and a validity clock tied to distance. This guide covers all of it in the order you will actually need it.',
    sections: [
      {
        heading: 'When an e-way bill is required',
        body: 'The general rule is that a registered person causing the movement of goods worth more than ₹50,000 — in a single invoice, bill of supply or delivery challan — must generate an e-way bill before the movement starts. The value includes the tax but excludes the value of exempt goods where the consignment is mixed.\n\nTwo cases require an e-way bill regardless of value. Inter-state movement of goods for job work, where the principal or the registered job worker must generate one whatever the consignment is worth. And inter-state movement of handicraft goods by a person exempted from registration. Beyond that, several states have set their own intra-state thresholds, and a few have raised the limit for movements within a city or district, so check your state’s notification if you operate close to the boundary.\n\nThe threshold applies per consignment, not per day. Splitting a ₹90,000 order into two ₹45,000 invoices moving on the same vehicle does not avoid the requirement, and the practice is treated as evasion.',
      },
      {
        heading: 'Part A and Part B: two halves, two owners',
        body: 'An e-way bill has two parts and they are usually filled by different people, which is where confusion starts.\n\nPart A is the consignment information: the recipient’s GSTIN, place of delivery with PIN code, the invoice or challan number and date, the value of goods, the HSN code, the reason for transportation, and the transport document number. This is the supplier’s job, and it can be filled well before dispatch.\n\nPart B is the vehicle information: the vehicle number, or the transporter document number for rail, air or ship. Without Part B, the e-way bill is not valid for movement — the validity clock does not even start. Part B is filled by whoever knows the vehicle, which is the supplier for own transport and the transporter for hired transport. When a transporter is engaged, the supplier furnishes Part A and the transporter ID, and the transporter completes Part B.\n\nThere is one relaxation worth knowing: for movement within a state up to 50 kilometres between the consignor’s place and the transporter’s place, or from the transporter to the consignee, Part B is not required.',
        bullets: [
          'Part A — consignment details, filled by the supplier, can be done in advance',
          'Part B — vehicle or transport document number, without which the bill is not valid',
      ...
      },
      {
        ...
        body: 'Validity runs from the time Part B is entered, not from when Part A was filled. For regular cargo, the bill is valid for one day for every 200 kilometres or part thereof. For over-dimensional cargo and multimodal shipment involving at least one leg by ship, it is one day for every 20 kilometres or part thereof.\n\n"One day" means until midnight of the day following the date of generation for the first block, which is more generous than it sounds — a bill generated at 6 pm for a 150 km trip is valid until midnight the next day, not until 6 pm the next day. Plan long hauls with this in mind, because expired e-way bills are among the most common reasons for detention.\n\nIf the goods cannot be moved within the validity — a breakdown, a natural calamity, a transhipment delay — the transporter can extend it by updating the details, but only within eight hours before or after expiry. Miss that window and you must generate a fresh bill, which requires the goods to still be accompanied by valid documents.',
      },
      {
        heading: 'Cancellation, rejection and changing the vehicle',
        body: 'An e-way bill can be cancelled within 24 hours of generation, provided the goods have not been transported or the details were entered incorrectly. After 24 hours, cancellation is not possible from the generator’s side. The recipient has a separate right: they may reject an e-way bill within 72 hours of generation, or before delivery, whichever is earlier — useful when a supplier raises a bill against your GSTIN for a consignment you never ordered.\n\nVehicle changes mid-journey are normal and handled by updating Part B with the new vehicle number. Multiple vehicle updates are permitted, and the validity does not reset — it continues from the original Part B entry. For consolidated movements, a transporter carrying several consignments in one vehicle generates a consolidated e-way bill listing the individual bill numbers, which the driver carries in place of a bundle of printouts.',
      },
      {
        heading: 'What must travel with the goods',
        body: 'The person in charge of the conveyance must carry the invoice, bill of supply or delivery challan, and a copy of the e-way bill or its number — physically, or mapped to a Radio Frequency Identification Device where the state requires it. In practice, the e-way bill number or a QR code on a phone is accepted, but a printed copy costs nothing and removes the argument.\n\nWhere goods move on a delivery challan rather than an invoice — job work, exhibition, branch transfer, supply on approval — the e-way bill references the challan number and the appropriate sub-type. Getting the sub-type right matters: a job-work movement recorded as an ordinary supply creates a mismatch between your e-way bill data and your GSTR-1, and those mismatches now generate automated queries.',
      },
      {
        heading: 'Exemptions worth knowing',
        body: 'Several movements do not require an e-way bill at all. Goods transported by a non-motorised conveyance — a handcart, a cycle rickshaw. Goods moving from a port, airport, air cargo complex or land customs station to an inland container depot or container freight station for customs clearance. Movement within areas notified by a state government. Transport of empty cargo containers. Goods exempt under the specific annexure to Rule 138, which covers a long list including fresh fruit and vegetables, unprocessed cereals, milk, live animals, books and jewellery.\n\nCheck the annexure rather than assuming, because the list contains items people expect to be covered and omits items people assume are exempt. And note that "no e-way bill required" never means "no document required" — the invoice or challan still travels with the goods.',
      },
      {
        heading: 'Penalties for getting it wrong',
        body: 'Moving goods without a required e-way bill attracts a penalty under Section 129: for taxable goods where the owner comes forward, 200% of the tax payable on the goods, or in the case of exempt goods, 2% of the value or ₹25,000, whichever is less. Where the owner does not come forward, the exposure rises to 50% of the value of goods. The vehicle and goods can be detained until the amount is paid.\n\nCourts have distinguished between genuine clerical errors and deliberate evasion — a typographical error in a vehicle number with all other documents in order has repeatedly been held not to justify the full penalty. But relying on that is expensive and slow. The cheaper approach is boring discipline: generate the bill before dispatch, verify the vehicle number against the actual truck, confirm the validity covers the planned route, and keep a printed copy in the cab.',
      },
    ],
    faqs: [
      {
        q: 'Is an e-way bill needed for goods moving within the same city?',
        a: 'It depends on your state. The central rule sets a ₹50,000 threshold, but states may notify higher limits or exemptions for intra-city and intra-district movement, and several have. Check your state commercial tax department’s current notification rather than relying on general advice.',
      },
      {
        q: 'Who generates the e-way bill when the buyer arranges transport?',
        a: 'Where the recipient causes the movement — an ex-works sale where the buyer sends their own vehicle — the recipient generates it. Where the supplier arranges transport, the supplier does. An unregistered supplier selling to a registered buyer is treated as the registered recipient causing the movement.',
      },
      {
      ...
      },
      {
        ...
        a: 'Goods sent for repair move on a delivery challan rather than an invoice, and the e-way bill requirement follows the normal rules — value above ₹50,000 for intra-state, and for inter-state job work movements regardless of value. Select the correct sub-type and reference the challan number.',
      },
    ],
