...
export const blogPosts3: BlogPost[] = [
  {
    ...
    references: [
      { label: 'GST Portal — E-Invoice Portal', url: 'https://einvoice1.gst.gov.in' },
      { label: 'CBIC — Invoicing Guidelines', url: 'https://www.cbic.gov.in' },
    ],
  ...
  },
  {
    ...
    references: [
      { label: 'MSME — Market Development Assistance', url: 'https://msme.gov.in' },
      { label: 'CBIC — Place of Supply Rules', url: 'https://www.cbic.gov.in' },
    ],
  ...
  },
  {
    ...
    references: [
      { label: 'GST Portal — GST Rates for Goods', url: 'https://www.gst.gov.in' },
      { label: 'CBIC — HSN Classification', url: 'https://www.cbic.gov.in' },
    ],
  ...
  },
  {
    ...
    references: [
      { label: 'GST Portal — Time of Supply', url: 'https://www.gst.gov.in' },
      { label: 'CBIC — Supply Provisions', url: 'https://www.cbic.gov.in' },
    ],
  ...
  },
  {
    ...
    references: [
      { label: 'RBI — Payment System Guidelines', url: 'https://www.rbi.org.in' },
      { label: 'MSME Samadhaan — Delayed Payments', url: 'https://samadhaan.msme.gov.in' },
    ],
  ...
  },
  {
    ...
    references: [
      { label: 'GST Portal — Common FAQs', url: 'https://www.gst.gov.in' },
      { label: 'CBIC — Compliance Checklist', url: 'https://www.cbic.gov.in' },
    ],
