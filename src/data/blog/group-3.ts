...
export const blogPosts3: BlogPost[] = [
  {
    ...
    metaDescription: 'Learn the exact email format for sending quotations in India â€" what subject line to use, how to write the body, when to follow up, and common mistakes to avoid.',
    ...
    excerpt: 'The way you email a quotation matters as much as the document itself â€" here is the exact format that gets opened, read, and approved faster.',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Keep the file size under 2 MB â€" compress if your template is image-heavy',
      ...
      },
      {
        ...
        body: 'Tuesday to Thursday mornings between 9 AM and 11 AM consistently produce higher open rates for business emails in India. Monday mornings are cluttered with weekend backlog; Friday afternoons get ignored until the following week.\n\nIf a client requested a quotation during a call, sending it within two hours of that call is ideal â€" your name and the conversation are still fresh. Avoid sending quotations late at night or over the weekend unless the client specifically asked you to.',
      },
      {
        heading: 'What to write in the follow-up email',
        body: 'If there is no response within two to three days, a brief follow-up works well. Do not write "just following up" â€" instead, add one piece of value: "I wanted to check if you had a chance to review the quotation. I can also separate the furniture and installation charges if that makes budget approval easier on your end â€" happy to revise if needed."\n\nThis signals that you are flexible and attentive, not just chasing a yes. If there is still no response after the first follow-up, wait another five to seven days before sending a final polite check-in.',
      },
      {
        heading: 'Common email mistakes that delay approvals',
        body: 'Sending from a personal Gmail instead of a business email address erodes trust significantly â€" many Indian SME clients will not take a quotation seriously if it comes from a free email provider. If you have a domain, use it.\n\nAlso avoid: sending without a greeting or sign-off (looks like spam), attaching multiple versions confusingly labeled v1 and v2, and cc-ing colleagues the client has never met without introducing them. Keep the first email clean and direct.',
      },
    ],
    faqs: [
      { q: 'Should I WhatsApp the quotation or email it?', a: 'Email is preferable for formal quotations since it creates a paper trail, but following up over WhatsApp after emailing is very effective in India â€" a quick "sent you the quote on email, please check" dramatically improves open rates.' },
      { q: 'What if the client asks for the quotation on WhatsApp directly?', a: 'Send the PDF over WhatsApp if that is what they asked for, but simultaneously email it to them as well â€" email creates a more traceable record and is better if there is a dispute later.' },
      { q: 'How many times should I follow up on an unanswered quotation?', a: 'Three follow-ups over about 15 days is a reasonable limit â€" day 3, day 8, and a final close-the-loop message around day 15 asking if the project is still active.' },
      { q: 'Should I mention a discount in the email body?', a: 'Avoid mentioning a potential discount proactively â€" it immediately signals that your original price was not your best price and opens up negotiation before the client has even read the quote.' },
      { q: 'Is it okay to send a quotation on a public holiday?', a: 'Schedule it to send on the next working morning instead â€" most email platforms let you delay send, and a holiday email often gets buried or missed when the recipient returns.' },
    ],
    references: [
      { label: 'GST Portal â€" E-Invoice Portal', url: 'https://einvoice1.gst.gov.in' },
      { label: 'CBIC â€" Invoicing Guidelines', url: 'https://www.cbic.gov.in' },
    ],
  ...
  },
  {
    ...
    metaDescription: 'Practical negotiation strategies for Indian businesses â€" how to handle price pushback, what to concede, when to hold firm, and how to protect your profit margin during a quote negotiation.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'The biggest mistake businesses make when faced with price pushback is offering a discount without changing anything â€" just dropping the number to save the deal. This sets a dangerous precedent: the client learns that your first price was inflated, and they will always negotiate with you in future.\n\nInstead, offer to reduce the price by reducing the scope. "I can bring this to Rs 50,000 if we move the third phase â€" the social media integration â€" to a Phase 2 scope after initial launch." Now you have maintained your rate per hour or unit; you have simply done less work. The client gets to feel like they won something real.',
        bullets: [
    ...
    faqs: [
      { q: 'Is it unprofessional to negotiate on a quotation in India?', a: 'No â€" negotiation is expected in most Indian B2B contexts. What matters is how you negotiate: professionally, with clear reasoning, and without desperation. Clients respect vendors who can hold a principled position.' },
      ...
      { q: 'Should I ever offer an upfront discount to close faster?', a: 'Only if it is genuinely mutual â€" like "if you can confirm by Friday, I can hold this price and fit you into our schedule next week." Make it time-bound and tied to a commitment, not just a freebie.' },
    ...
    references: [
      { label: 'MSME â€" Market Development Assistance', url: 'https://msme.gov.in' },
      { label: 'CBIC â€" Place of Supply Rules', url: 'https://www.cbic.gov.in' },
    ],
  ...
  },
  {
    ...
    metaDescription: 'Step-by-step guide to writing retail quotations in India â€" covering product descriptions, GST, delivery terms, bulk discounts, and what to include for B2B retail buyers.',
    ...
    excerpt: 'A retail quotation is your first commercial document â€" here is what separates the ones that get approved from the ones that go to a competitor.',
    intro: 'Whether you run a shop, a wholesale distribution business, or a product-based startup, sending a well-structured quotation is one of the most important sales steps you will take. Retail buyers â€" particularly B2B ones like retailers, resellers, and institutions â€" judge your professionalism and reliability almost entirely on the quality of your first quotation. Here is exactly how to write one that closes deals.',
    sections: [
      {
        heading: 'What makes a retail quotation different from a service quote',
        body: 'A service quotation describes work. A retail quotation describes products â€" and that distinction changes almost everything about its structure.\n\nIn a retail or product quotation, the emphasis is on precise specifications (size, colour, model number, brand), accurate unit pricing, minimum order quantities, and delivery or logistics terms. A buyer comparing three vendor quotations for 500 units of an office chair needs to be able to read your quote in thirty seconds and know exactly what they are buying, at what price per unit, with what delivery date and minimum order requirement.',
      },
      {
        heading: 'List every product detail that matters to the buyer',
        body: 'Vague product descriptions kill retail quotations. "Office Chair â€" Rs 3,500 per unit" tells the buyer almost nothing. "Ergonomic Mesh Office Chair, Model No. EC-405, High Back, Black, 1-year warranty â€" Rs 3,500/unit" tells them exactly what they are comparing.\n\nFor each line item include: product name, model or SKU, brand (if applicable), specifications (dimensions, material, colour options), unit price, minimum order quantity, and any lead time for delivery. If your product has an HSN code â€" which all goods sold under GST do â€" include it to make the buyer\'s tax accounting easier.',
        bullets: [
      ...
      },
      {
        ...
        body: 'Most established retail buyers will push for credit terms â€" 30, 45, or 60 days. If you are new to a buyer relationship, it is reasonable to start with full advance or a 50/50 split for the first two orders, and extend credit terms once you have established a track record together.\n\nInclude your bank account details for NEFT/RTGS transfers and your UPI ID for smaller orders. Specify whether cheques are accepted and, if so, the clearance period before goods are dispatched.',
      },
    ],
    faqs: [
      ...
      { q: 'How long should a retail quotation be valid?', a: 'Seven to fifteen days is standard for product quotations since raw material and logistics costs fluctuate. State the validity clearly and stick to it â€" honouring your quoted price builds trust, but so does being upfront when prices change.' },
      ...
      { q: 'What if a buyer wants a sample before placing an order?', a: 'Include a sample policy in your quotation if this is common for your product category â€" stating sample cost, lead time, and whether it is refundable against the first order.' },
    ],
    references: [
      { label: 'GST Portal â€" GST Rates for Goods', url: 'https://www.gst.gov.in' },
      { label: 'CBIC â€" HSN Classification', url: 'https://www.cbic.gov.in' },
    ],
  ...
  },
  {
    ...
    metaDescription: 'Learn how to set the right validity period for your business quotations in India â€" why it matters legally and commercially, what happens when quotes expire, and industry norms.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'A quotation that expires in 7 days creates more urgency than one valid for 90 days â€" but only if the client believes the urgency is real. If you routinely extend validity on request without reason, it signals that your prices are soft and the deadline is meaningless.\n\nReserve extensions for clients who are genuinely interested but have an internal approval process taking slightly longer. When you extend, state a reason: "Given your committee meets next Tuesday, I\'ve extended the validity to 20 July â€" after that, I\'ll need to check if our production slot is still open." This keeps the urgency credible.',
      },
    ],
    faqs: [
    ...
    references: [
      { label: 'GST Portal â€" Time of Supply', url: 'https://www.gst.gov.in' },
      { label: 'CBIC â€" Supply Provisions', url: 'https://www.cbic.gov.in' },
    ],
  ...
  },
  {
    ...
    metaDescription: 'A practical guide to writing clear payment terms in your quotations â€" advance payment, milestone billing, credit periods, late payment clauses, and examples for Indian businesses.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Asking for advance payment makes many businesses uncomfortable â€" they worry it signals distrust or will push the client away. In reality, advance payment is professionally normal across virtually every industry in India, and clients who refuse any advance should be considered carefully.\n\nFrame it as a process rather than a distrust signal: "As is standard for custom projects, we require 50% advance before commencing work to schedule your slot and procure materials." This normalises it and removes any personal element.',
      },
      {
        heading: 'Late payment clauses: whether and how to include them',
        body: 'A late payment clause states that a penalty (typically 1.5% to 2% per month) applies to outstanding amounts past the due date. Including this in a quotation is entirely professional, but the wording and positioning matter.\n\nPlace it in the Terms and Conditions section at the bottom, not prominently mid-page â€" it should read as standard boilerplate, not as an accusation before you have even started working together. Wording example: "Amounts outstanding beyond the due date are subject to a late payment charge of 1.5% per month until settlement."\n\nIn practice, enforce it selectively â€" with long-term clients you value, a polite reminder will usually suffice before invoking the clause.',
      },
      {
    ...
    faqs: [
      ...
      { q: 'What if a client refuses to pay the advance?', a: 'You can negotiate the structure â€" for example, a smaller advance of 25% â€" but avoid starting work with zero advance for new or unfamiliar clients. If they refuse any advance at all, ask yourself what that signals about the relationship.' },
    ...
    references: [
      { label: 'RBI â€" Payment System Guidelines', url: 'https://www.rbi.org.in' },
      { label: 'MSME Samadhaan â€" Delayed Payments', url: 'https://samadhaan.msme.gov.in' },
    ],
  ...
  },
  {
    ...
    metaDescription: 'Discover the 10 most common quotation mistakes Indian businesses make â€" from vague pricing to missing GST details â€" and exactly how to fix each one to win more deals.',
    ...
    excerpt: 'Most lost deals are not lost on price â€" they are lost because the quotation itself created doubt, confusion, or a poor first impression.',
    intro: 'After looking at hundreds of quotations sent by Indian businesses, the same mistakes appear repeatedly. They are not complex errors â€" they are fixable gaps in structure, clarity, and presentation that quietly cost deals. Here are the ten most common ones, and what to do instead.',
    sections: [
      {
      ...
      },
      {
        ...
        body: 'The most common complaint from B2B buyers reviewing multiple vendor quotations is that they cannot compare them because the descriptions are too vague. "Consulting services â€" Rs 50,000" tells a buyer nothing. What services? For how long? What deliverables?\n\nFix: Every line item should answer: what, how much of it, in what unit, and at what rate. "Brand strategy consulting â€" 3 sessions (2 hours each) + written strategy document â€" Rs 50,000" is completable and comparable.',
      },
      {
        heading: 'Mistake 3: Missing or incorrectly calculated GST',
        body: 'GST errors are the number one reason quotations get sent back for revision in India. Whether you have applied CGST+SGST when you should have applied IGST, used the wrong percentage, or simply left GST off entirely â€" it slows down the approval process.\n\nFix: Check whether the transaction is intra-state or inter-state. Use the correct GST rate for your HSN/SAC code. Show the calculation explicitly: subtotal, CGST 9%, SGST 9% (or IGST 18%), and final total.',
      },
      {
      ...
      },
      {
        ...
        body: 'Mistake 8: Sending from a personal Gmail instead of a business domain email address â€" it signals either a freelancer with no business structure or a company too small to invest in a basic business email.\n\nMistake 9: No terms and conditions section â€" leaving out delivery terms, warranty clauses, dispute resolution, and cancellation policy means you have no documented basis if anything goes wrong.\n\nMistake 10: Not following up â€" sending a quotation and waiting passively for a response. The single most effective thing most businesses can do to win more deals is send one structured follow-up email three days after the quotation.',
      },
    ],
    faqs: [
      ...
      { q: 'Is there a way to know if my quotation has been opened?', a: 'QuotationMaker includes read receipts that tell you when a client has opened the link to your quotation â€" so you can time your follow-up call for when the conversation is fresh.' },
    ],
    references: [
      { label: 'GST Portal â€" Common FAQs', url: 'https://www.gst.gov.in' },
      { label: 'CBIC â€" Compliance Checklist', url: 'https://www.cbic.gov.in' },
    ],
