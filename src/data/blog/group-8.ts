...
/**
 * Group 8 â€" the operational side of running a small Indian business: pricing,
...
export const blogPosts8: BlogPost[] = [
  {
    ...
    metaDescription:
      'A practical guide to TDS for Indian small businesses â€" Section 194C, 194J, 194H, 194-IB and 194Q thresholds and rates, how TDS interacts with GST on your invoice, Form 16A and claiming credit in your return.',
    keywords: [
      'tds on payments',
    ...
    excerpt:
      'Your client paid â‚¹90,000 against a â‚¹1,00,000 invoice and called it TDS. Here is what that means, whether they were right, and how you get the money back.',
    intro:
      'The first time a client pays you less than you invoiced and cheerfully explains it as "TDS", it feels like a deduction you have been talked into. It is not â€" it is tax paid on your behalf to the government, and you claim it back against your own tax liability when you file. But whether the deduction was correct, at what rate, and how you recover it, are questions most freelancers and small suppliers never get a straight answer to. This guide covers the sections that actually apply to small-business payments, how TDS interacts with GST on your bill, and what to do when the credit does not show up.',
    sections: [
      {
        heading: 'What TDS is and who deducts it',
        body: 'Tax Deducted at Source is a collection mechanism: instead of waiting for you to pay tax at year end, the government requires the person paying you to withhold a slice and deposit it against your PAN. The deductor files a quarterly return, the amount appears in your Form 26AS and Annual Information Statement, and you claim it as a credit against your tax liability when you file your return.\n\nNot every payer deducts. Individuals and Hindu Undivided Families are generally required to deduct under the business-payment sections only if their turnover exceeded â‚¹1 crore for business or â‚¹50 lakh for profession in the preceding financial year. Companies, firms and LLPs deduct regardless of size. So a large agency will deduct on your invoice while a small proprietor client may not â€" and both can be correct.',
      },
      {
        heading: 'The sections that matter for small business payments',
        body: 'Five cover most situations.\n\nSection 194C, contract payments, applies to work contracts including advertising, catering, transport, manufacturing to specification, and most job work. The rate is 1% where the payee is an individual or HUF and 2% otherwise. Thresholds apply per single payment and per annual aggregate â€" deduction is triggered when a single contract payment crosses the prescribed single-transaction limit or when the annual aggregate to that payee crosses the yearly limit.\n\nSection 194J, professional and technical services, covers legal, medical, engineering, architectural, accountancy, technical consultancy, interior decoration and advertising professionals, plus royalty and non-compete payments. The standard rate is 10%, reduced to 2% for fees for technical services, call-centre operations and certain royalty payments. This is the section most freelance consultants, designers and developers are deducted under.\n\nSection 194H covers commission and brokerage, at 5%. Section 194-IB requires an individual or HUF paying rent above â‚¹50,000 a month to deduct 5%. And Section 194Q applies to buyers with turnover above â‚¹10 crore purchasing goods above â‚¹50 lakh from a single seller in a year, at 0.1% on the excess.\n\nRates and thresholds are revised in Finance Acts, so confirm the current figures for the financial year before relying on them â€" the structure stays stable, the numbers move.',
        bullets: [
          '194C â€" contracts and job work: 1% for individuals/HUF, 2% for others',
          '194J â€" professional and technical services: 10%, or 2% for technical services',
          '194H â€" commission and brokerage: 5%',
          '194-IB â€" rent above â‚¹50,000/month paid by individuals or HUF: 5%',
          '194Q â€" large buyers purchasing goods: 0.1% above the annual threshold',
        ],
      },
      {
        heading: 'TDS is deducted on the value before GST â€" usually',
        body: 'This is the question that causes the most invoice arguments, and the answer is clear. Where the GST component is shown separately on the invoice, TDS is deducted on the value excluding GST. A CBDT circular settled this for service payments, and the same logic is applied generally in practice.\n\nA worked example. You invoice â‚¹1,00,000 for consultancy plus 18% GST, so â‚¹1,18,000 total. Your client deducts 194J at 10% on â‚¹1,00,000, which is â‚¹10,000, and pays you â‚¹1,08,000. You still owe the full â‚¹18,000 GST to the government, and you claim the â‚¹10,000 as income tax credit.\n\nThe condition is that GST must be shown separately. If your invoice says "â‚¹1,18,000 inclusive of taxes" without a breakup, the deductor is entitled to compute TDS on the whole â‚¹1,18,000 â€" costing you an extra â‚¹1,800 of cash flow until you claim it back. Always show the tax split.\n\nNote that TDS under income tax is entirely different from TDS under GST (Section 51), which applies to specified government departments and public sector undertakings deducting 2% on contracts above â‚¹2.5 lakh. If you supply to government bodies, you may see both.',
      },
      {
        heading: 'What to do if you have no PAN â€" and what to do about the certificate',
        body: 'Section 206AA is unforgiving: if you do not furnish a PAN, the deductor must deduct at the higher of the applicable rate or 20%. Give your PAN on your invoice and in your vendor onboarding form and this never becomes an issue. Higher rates also apply to non-filers under Section 206AB, so keeping your returns filed is not merely a compliance nicety â€" it directly changes what your customers withhold from you.\n\nThe deductor must issue Form 16A quarterly, downloaded from TRACES. Ask for it, and reconcile it against Form 26AS and your Annual Information Statement on the income tax portal. The most common failure is the client deducting but not depositing, or depositing against the wrong PAN. Either way the credit will not appear, and no amount of holding the clientâ€™s email is a substitute â€" the portal is what the assessing officer sees. If a credit is missing, ask the deductor to file a correction statement, and follow up before the year closes.',
      },
      {
        heading: 'When you can ask for lower or nil deduction',
        body: 'If your total tax liability for the year will be less than the TDS being deducted â€" common for businesses in a loss year, or professionals with heavy deductible expenses â€" you can apply under Section 197 in Form 13 for a lower or nil deduction certificate. Once granted, you give the certificate to your clients and they deduct at the reduced rate.\n\nThis is genuinely worth doing where TDS is materially locking up your working capital. A consultant billing â‚¹40 lakh a year with 10% deducted has â‚¹4 lakh sitting with the government until the refund arrives, which can be a year later. For businesses where that â‚¹4 lakh is the difference between hiring and not hiring, the Form 13 process pays for itself.',
      },
      {
        heading: 'Reflecting TDS cleanly on your own documents',
        body: 'Do not deduct TDS on your own invoice â€" the deduction is the payerâ€™s obligation and the payerâ€™s calculation. Your invoice shows the full amount payable. What helps is a note in the terms stating your PAN and, where relevant, "TDS, if applicable, may be deducted under Section 194J on the taxable value excluding GST." That single line prevents both the wrong-base error and the awkward phone call.\n\nOn the receipt side, when the client pays the net amount, record the receipt for the net figure and the TDS as a separate entry against the invoice, so the invoice shows as fully settled rather than perpetually short. Businesses that skip this end the year with a receivables ledger full of small unexplained balances that are, in fact, all TDS.',
      },
    ],
    faqs: [
      {
        q: 'Do freelancers have to deduct TDS on payments they make?',
        a: 'Only if your turnover exceeded â‚¹1 crore for business or â‚¹50 lakh for profession in the previous financial year. Below that, an individual or HUF generally has no obligation under the business-payment sections â€" though Section 194-IB rent deduction can still apply if you pay over â‚¹50,000 a month in rent.',
      },
      {
        q: 'Can I refuse a client who deducts TDS?',
        a: 'There is nothing to refuse â€" a deductor who is required to deduct has no discretion, and failing to deduct exposes them to interest, penalty and disallowance of the expense. The money is not lost; it is credited against your tax. If cash flow is the concern, apply for a lower deduction certificate under Section 197.',
      },
      {
        q: 'What if TDS was deducted at the wrong section or rate?',
        a: 'Raise it with the deductor before their quarterly return is filed, when a correction is easy. After filing, they must submit a correction statement. Your claim in your return should match what appears in Form 26AS, so the fix has to happen at the deductorâ€™s end.',
      },
      {
        q: 'Is TDS applicable on reimbursements?',
        a: 'Pure reimbursements of expenses incurred on the clientâ€™s behalf, billed at cost with supporting bills and shown separately on the invoice, are generally not subject to TDS. Bundle them into your fee line and they become part of the taxable payment. Bill reimbursements as separate line items with documentation.',
      },
      {
    ...
    references: [
      { label: 'Income Tax India â€" TDS Rates', url: 'https://www.incometax.gov.in' },
      { label: 'CBIC â€" TDS Under GST', url: 'https://www.cbic.gov.in' },
    ],
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Create the year folder and its subfolders. Move the last three months of documents into it, correctly named, so the structure has content and you learn where the gaps are. Set up an automatic cloud sync for that folder, and a second copy on an external drive or a different cloud account. Write your naming convention on a note inside the folder so anyone else in the business follows it too.\n\nThen decide the one rule you will not break: every document gets saved the day it is created or received. If you generate invoices, quotations, challans and receipts through a browser-based document tool, the PDF exists at the moment you finish â€" saving it into the right folder is a two-second step. Two seconds, taken every time, is the entire difference between a business that can answer a notice and one that cannot.',
      },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: 'Yes. Retention obligations run from the transaction and the return, not from whether the business is operating. Cancellation of GST registration does not end the requirement, and assessments can be reopened after closure. Archive the final yearâ€™s records the same way you would for an operating year.',
      },
      {
    ...
    references: [
      { label: 'MCA â€" Books of Account Rules', url: 'https://www.mca.gov.in' },
      { label: 'Income Tax India â€" Record Retention', url: 'https://www.incometax.gov.in' },
    ],
...

  {
    ...
    metaDescription:
      'A step-by-step method for pricing services â€" calculating your true cost per hour, choosing between hourly, fixed and value pricing, setting margins, handling discount requests and raising rates with existing clients.',
    keywords: [
    ...
    excerpt:
      'Most small businesses price by looking at what competitors charge and shaving 10%. That is not a strategy â€" it is a slow way to work hard for nothing.',
    intro:
      'Ask a service business owner how they arrived at their rate and the honest answer is usually some combination of what the last client paid, what a competitor quotes, and what felt sayable without flinching. It works well enough to stay busy and badly enough to stay broke. The gap between those two outcomes is not sales skill â€" it is knowing your actual cost of delivering an hour of work, and then choosing a pricing model deliberately instead of defaulting to one. This guide walks through the arithmetic, the three pricing models and when each fits, and the two conversations everybody dreads: the discount request and the rate increase.',
    sections: [
      {
        heading: 'Start with your real cost per productive hour',
        body: 'Every pricing decision rests on one number: what it costs you to deliver one hour of billable work. Most people estimate it by dividing their salary expectation by 2,000 hours, which is wrong in two ways â€" it ignores overheads and it assumes every working hour is billable.\n\nDo it properly. Add up your annual fixed costs: your own target income, salaries, rent, software subscriptions, internet and phone, professional fees, travel, equipment depreciation, insurance, and a line for taxes. Then work out your genuinely billable hours. A full year is roughly 2,000 working hours, but sales, admin, invoicing, follow-ups, learning and unpaid revisions consume a large share. For most independent service providers, 55 to 65 percent billable is realistic â€" call it 1,200 hours. A small team with dedicated admin support might reach 70 percent.\n\nDivide annual costs by billable hours and you have your break-even rate. If your costs are â‚¹12,00,000 and you bill 1,200 hours, you must earn â‚¹1,000 an hour just to stand still. Every rate below that is subsidised by you.',
        bullets: [
          'Fixed costs include your own target income â€" you are not a free input',
          'Billable hours are 55â€"65% of working hours for most independents, not 100%',
          'Break-even rate = annual costs Ã· billable hours',
          'Add your target margin on top of break-even, not on top of nothing',
          'Recalculate annually â€" costs drift upward, rates usually do not',
        ],
      },
      {
        heading: 'Margin is not the same as markup',
        body: 'This confusion costs real money. Markup is calculated on cost; margin is calculated on price. A â‚¹1,000 cost sold at â‚¹1,300 is a 30% markup but only a 23% margin. Businesses that think they are running 30% margins on a 30% markup are systematically over-optimistic about profitability.\n\nTo hit a target margin, divide rather than multiply: price equals cost divided by one minus the margin. For a 30% margin on â‚¹1,000 of cost, that is â‚¹1,000 Ã· 0.7 = â‚¹1,429. Build this into your quotation arithmetic once and it stops being a thing you get wrong under time pressure.\n\nSet the margin deliberately by work type. Routine, competitive, low-risk work carries a thinner margin. Specialised work, tight deadlines, high-liability projects and anything requiring skills that are scarce in your market carry more. A single blended rate across all your work means you are overcharging for the easy jobs you win and undercharging for the hard ones you dread.',
      },
      {
        heading: 'Hourly, fixed or value: choosing the model',
        body: 'Hourly pricing suits work where scope genuinely cannot be defined in advance â€" ongoing support, consulting on evolving problems, maintenance retainers. Its weakness is structural: it caps your income at your hours and it penalises you for getting faster. The moment you become expert enough to do in two hours what took five, hourly billing cuts your income.\n\nFixed-price project quoting suits defined deliverables â€" a website, an interior fit-out, an audit, an event. It is what most clients prefer because it removes their uncertainty. The risk transfers to you, which is exactly why fixed prices must include a contingency: estimate the hours honestly, then add 15 to 25 percent for the things that always happen. And they must be paired with a written scope, because fixed price without fixed scope is how projects consume their entire margin in revisions.\n\nValue-based pricing sets the fee against the clientâ€™s outcome rather than your effort. It fits where your work has a measurable financial impact â€" a campaign that generates leads, a system that saves labour cost, a design that lifts conversion. It requires you to understand the clientâ€™s economics and to have the confidence to discuss them, which is why most people avoid it. It is also where the highest margins in service businesses live.\n\nMost mature service businesses use all three: retainers hourly, projects fixed, and strategic engagements on value.',
      },
      {
        heading: 'Building the quote so the price is not the only thing visible',
        body: 'A quotation showing a single line and a single number invites one response: negotiate the number. A quotation showing what is included, what is excluded, the delivery timeline, the revision allowance and the payment schedule invites a conversation about scope, which is a conversation you can win.\n\nItemise enough to show the work, not so much that you invite line-by-line deletion. Three to seven meaningful line items usually strikes the balance. State exclusions explicitly, because unstated exclusions become included by assumption. Cap revisions in writing â€" two rounds is a common norm, with further rounds billed. And put the validity period on the quote, so todayâ€™s price is not still being argued about in November.\n\nOffering tiered options changes the dynamic further. When a client sees only one price, the decision is yes or no. When they see three â€" a lean version, a standard version and a comprehensive version â€" the decision becomes which one, and the middle option becomes the natural anchor. This is not manipulation; it is giving the buyer a genuine choice about scope rather than a binary on cost.',
      },
      {
        heading: 'When the client asks for a discount',
        body: 'The instinctive response â€" shave 10% to close the deal â€" teaches the client that your first price was inflated and that every future price is negotiable. Once learned, that lesson never unlearns.\n\nThe better response trades rather than concedes. If the budget is â‚¹80,000 against a â‚¹1,00,000 quote, remove â‚¹20,000 of scope. Offer a lower price for a longer timeline that lets you fit the work around better-paying jobs. Offer a discount for full advance payment, which has real cash-flow value to you. Offer a reduced rate for a longer commitment â€" a three-month retainer at a lower monthly figure. Each of these preserves the principle that price tracks value delivered.\n\nAnd be willing to lose the job. A client who will only proceed below your break-even rate is not a client, they are a subsidy. Businesses that never lose a quote on price are almost certainly priced too low.',
      },
      {
        heading: 'Raising rates with existing clients',
        body: 'This is the single highest-return action most small businesses never take. Costs rise every year; rates for existing clients often stay frozen for three or four, which is a silent margin collapse.\n\nDo it on a schedule rather than when resentment builds. Announce in writing, six to eight weeks ahead, with a specific effective date. Keep the explanation short and factual â€" rates are being revised across the board â€" and do not over-justify. Apply it to new work and to renewals rather than mid-project. Where a client is genuinely valuable and price-sensitive, offer a grandfathered rate for a defined transition period rather than a permanent exception.\n\nExpect some attrition and plan for it. If you raise rates 15% and lose 10% of clients, you are ahead on revenue and further ahead on time. The clients most likely to leave over a modest increase are usually the ones consuming disproportionate effort. In practice, most owners who finally raise rates report that the majority of clients accept without comment, and the main cost was the months of anxiety beforehand.',
      },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: 'Per project, where the scope can be defined â€" it rewards efficiency, gives the client certainty and lets you price against value rather than time. Keep hourly for genuinely open-ended work, and always pair fixed prices with a written scope and a revision cap.',
      },
      {
    ...
    references: [
      { label: 'MSME â€" Market Intelligence Cell', url: 'https://msme.gov.in' },
      { label: 'GST Portal â€" GST for Service Providers', url: 'https://www.gst.gov.in' },
    ],
...

  {
    ...
    metaDescription:
      'The complete document workflow from quotation to payment â€" which document to issue at each stage, how they reference each other, where deals leak money and how to run the whole cycle with free online tools.',
    keywords: [
    ...
    faqs: [
      {
        ...
        a: 'Yes, and you should â€" the line items, rates and tax treatment carry over, which removes transcription errors. Give the invoice its own number in the invoice series, quote the quotation number as a reference, and never reuse the quotation number as an invoice number.',
      },
      {
        q: 'Do I need a purchase order from every customer?',
        a: 'Not from individuals or small businesses paying directly. For any organisation with an accounts department, ask â€" their internal approval process usually requires it, and an invoice without a purchase order reference is the most common cause of a payment stalling.',
      },
      {
        q: 'What if the customer asks for extra work mid-project?',
        a: 'Issue a revised quotation or a supplementary one covering the additional scope, and get it accepted in writing before doing the work. Scope added verbally is scope you will deliver for free â€" this is the single largest source of margin loss in service businesses.',
      },
      {
      ...
      },
      {
        ...
        a: 'Give each type its own prefixed series within the financial year â€" QT-, PO-, PI-, DC-, INV-, REC-, CN-, DN- â€" and never mix them. A document tool that maintains each series automatically removes the risk of duplicates and gaps, which are the two things auditors question first.',
      },
    ],
    references: [
      { label: 'GST Portal â€" Invoice to Payment', url: 'https://www.gst.gov.in' },
      { label: 'RBI â€" Payment Settlement Systems', url: 'https://www.rbi.org.in' },
    ],
...

  {
    ...
    metaDescription:
      'How Indian small businesses should accept UPI â€" putting a QR code on your invoice, personal vs business UPI accounts, transaction limits, the dynamic QR requirement for large B2C businesses, disputes and tax treatment.',
    keywords: [
      'upi for business',
    ...
    intro:
      'India settles more real-time payments than any other country, and for a small business that is not an abstract statistic â€" it is the difference between a customer paying on the spot and a customer paying next month. Yet a large share of invoices sent by Indian small businesses still carry only bank details, or nothing at all, requiring the customer to message and ask where to send the money. Every one of those exchanges is a delay. This guide covers how to accept UPI properly as a business: what to put on your documents, whether a personal handle is good enough, the limits that apply, and the compliance rules that kick in as you grow.',
    sections: [
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Only businesses above the notified turnover threshold are required to include a dynamic QR on B2C invoices under GST rules. For everyone else it is voluntary â€" and worth doing anyway, because it measurably shortens the time between a customer reading your invoice and paying it.',
      },
      {
      ...
      },
      {
        ...
        a: 'No. Income is income regardless of how it is received. The difference is visibility â€" digital receipts leave a complete trail, which makes accurate reporting easier and inaccurate reporting far riskier. There is also no â‚¹2 lakh single-transaction restriction as there is for cash under Section 269ST.',
      },
    ],
    references: [
      { label: 'NPCI â€" UPI Product Overview', url: 'https://www.npci.org.in/what-we-do/upi/product-overview' },
      { label: 'RBI â€" Digital Payments Framework', url: 'https://www.rbi.org.in' },
    ],
