...
export const industriesD: Industry[] = [
  {
    ...
    seoTitle: 'Civil Contractor Quotation Maker – Free Construction Estimate Format',
    metaDescription:
...
Because most civil contracts in India involve a mix of material supply and labour, and because clients frequently ask for revised quotations after negotiating quantities or specifications, having a tool that lets you duplicate, edit, and reissue quotes quickly is a genuine time-saver. Whether you're quoting for a farmhouse boundary wall in Nashik or a multi-storey commercial shell in Bengaluru, a clear line-item quotation reduces disputes at the billing stage and helps you get advances released faster.`,
    ...
    sampleItems: [
      { description: 'Excavation and earthwork for foundation', unit: 'cum', hsn: '995432', qty: 48, rate: 340 },
      { description: 'PCC (1:4:8) below foundation', unit: 'cum', hsn: '995432', qty: 16, rate: 4200 },
      { description: 'RCC work for columns, beams and slab (M20)', unit: 'cum', hsn: '995432', qty: 42, rate: 6800 },
      { description: 'Brickwork in cement mortar (9 inch wall)', unit: 'cum', hsn: '995432', qty: 64, rate: 5400 },
      { description: 'Internal and external plastering', unit: 'sqm', hsn: '995432', qty: 420, rate: 320 },
      { description: 'Vitrified tile flooring supply and fixing', unit: 'sqm', hsn: '995432', qty: 180, rate: 1250 },
    ],
    demo: {
      company: "Bhoomi Civil Contractors",
      address: "19, Ring Road, Vijay Nagar,\nIndore 452010",
      gstin: "23AAGCB6674Z1ZE",
      phone: "+91 94250 19960",
      email: "tenders@bhoomicivil.in",
      clientName: "Manish Jain",
      clientCompany: "Jain Warehousing LLP",
      clientAddress: "Khasra 210, Dewas Naka,\nIndore 452010",
      note: "Item rates as per BOQ. Measurements to be recorded jointly before each running bill.",
      terms: [
        "Item rates are as per the attached BOQ and hold for 30 days.",
        "Running bills raised fortnightly against joint measurement.",
        "Extra items outside the BOQ are executed only on written approval.",
        "Water, power and site storage are to be provided by the client.",
      ],
    },
    relatedSlugs: [
      'construction-quotation-maker',
...

  {
    ...
    seoTitle: 'Security Service Quotation Maker – Free Manpower Quote Format',
    metaDescription:
...
Because most security contracts renew annually and get revised whenever minimum wage notifications change, having a tool where you can quickly update rates and reissue a fresh quotation saves significant admin time. Agencies operating across multiple states also benefit from being able to note state-specific minimum wages, since a Delhi contract and a Karnataka contract will carry very different base pay components even for the same designation.`,
    ...
    sampleItems: [
      { description: 'Security Guard – 12 hour shift (per month)', unit: 'per guard', hsn: '998529', qty: 6, rate: 22000 },
      { description: 'Security Supervisor (per month)', unit: 'per supervisor', hsn: '998529', qty: 1, rate: 28000 },
      { description: 'Lady Security Guard – day shift (per month)', unit: 'per guard', hsn: '998529', qty: 2, rate: 21000 },
      { description: 'Gunman with valid arms licence (per month)', unit: 'per gunman', hsn: '998529', qty: 1, rate: 45000 },
      { description: 'Uniform and ID card kit (one-time)', unit: 'per set', hsn: '998529', qty: 9, rate: 1800 },
      { description: 'Walkie-talkie and equipment rental', unit: 'per month', hsn: '998529', qty: 4, rate: 900 },
    ],
    demo: {
      company: "Sentinel Security Services",
      address: "45, Sector 18, Udyog Vihar,\nGurugram 122015",
      gstin: "06AAFCS2218B1ZF",
      phone: "+91 98991 62240",
      email: "contracts@sentinelsecurity.in",
      clientName: "Latha Menon",
      clientCompany: "Orion Business Park",
      clientAddress: "Plot 6, Sector 62,\nNoida 201309",
      note: "Rates include PF, ESIC and statutory dues. Deployment starts after PSARA verification.",
      terms: [
        "Rates are inclusive of PF, ESIC and applicable statutory dues.",
        "Invoiced monthly in arrears with 15-day payment terms.",
        "Deployment begins after PSARA verification of the posted personnel.",
        "Relief for weekly offs and national holidays is charged additionally.",
      ],
    },
    relatedSlugs: [
...

  {
    ...
    seoTitle: 'Cleaning Service Quotation Maker – Free Housekeeping Quote Format',
    metaDescription:
...
Because cleaning quotations are often compared side by side with two or three competitors before a client decides, presenting a properly branded, itemised PDF instead of a text message rate list gives a noticeable edge. It also helps set the right expectations upfront about what is included — for instance, whether cleaning chemicals and equipment are provided by you or the client — which is one of the most common sources of disputes in this industry.`,
    ...
    sampleItems: [
      { description: 'Office housekeeping service (per sq.ft per month)', unit: 'sq.ft/month', hsn: '998533', qty: 8000, rate: 4.5 },
      { description: 'Deep cleaning – 2BHK apartment', unit: 'per service', hsn: '998533', qty: 1, rate: 6500 },
      { description: 'Sofa and carpet shampooing (per seat)', unit: 'per seat', hsn: '998533', qty: 7, rate: 450 },
      { description: 'Water tank cleaning (per tank)', unit: 'per tank', hsn: '998533', qty: 2, rate: 3200 },
      { description: 'Housekeeping staff deployment (per person per month)', unit: 'per person/month', hsn: '998533', qty: 4, rate: 18000 },
      { description: 'Cleaning consumables and chemicals (monthly)', unit: 'per month', hsn: '998533', qty: 1, rate: 8500 },
    ],
    demo: {
      company: "PureSpace Facility Services",
      address: "3, Deccan Gymkhana Road,\nPune 411004",
      gstin: "27AAHCP5541C1ZG",
      phone: "+91 90110 73380",
      email: "facility@purespace.in",
      clientName: "Imran Shaikh",
      clientCompany: "Nexus Corporate Tower",
      clientAddress: "Magarpatta City, Hadapsar,\nPune 411028",
      note: "Consumables billed monthly at actuals. Machine deep-cleaning scheduled quarterly.",
      terms: [
        "Quotation valid for 30 days from the date of issue.",
        "Invoiced monthly in advance for retainer-based housekeeping.",
        "Consumables and chemicals are billed monthly at actuals.",
        "Water and electricity at site are to be provided by the client.",
      ],
    },
    relatedSlugs: [
...

  {
    ...
    seoTitle: 'Transport Service Quotation Maker – Free Logistics Quote Format',
    metaDescription:
...
Because transport rates need frequent updates in response to diesel price changes and because the same client often books multiple trips or renews a monthly contract, having a quotation tool that lets you save standard routes and rates saves considerable time. A clean, GST-compliant PDF quotation also makes it easier to get onboarded as an approved vendor with larger corporates and logistics aggregators who require proper documentation before releasing purchase orders.`,
    ...
    sampleItems: [
      { description: 'Goods transport – 10 tonne truck (per trip, per km)', unit: 'per km', hsn: '996511', qty: 420, rate: 62 },
      { description: 'Mini tempo local delivery (per trip)', unit: 'per trip', hsn: '996511', qty: 12, rate: 2800 },
      { description: 'Vehicle rental for employee transport (per vehicle/month)', unit: 'per vehicle/month', hsn: '996511', qty: 3, rate: 42000 },
      { description: 'Loading and unloading labour charges', unit: 'per trip', hsn: '996511', qty: 12, rate: 1800 },
      { description: 'Toll and parking charges (as per actuals)', unit: 'lump sum', hsn: '996511', qty: 1, rate: 8500 },
      { description: 'Detention charges beyond free waiting period', unit: 'per hour', hsn: '996511', qty: 6, rate: 350 },
    ],
    demo: {
      company: "Sharda Roadlines",
      address: "Transport Nagar, Gate No. 4,\nLucknow 226012",
      gstin: "09AAKCS8809D1ZH",
      phone: "+91 94150 28810",
      email: "dispatch@shardaroadlines.in",
      clientName: "Gaurav Singh",
      clientCompany: "AgroMart Distributors",
      clientAddress: "Mandi Samiti, Sitapur Road,\nLucknow 226021",
      note: "Freight quoted door-to-door. Toll, parking and detention are charged at actuals.",
      terms: [
        "Freight rates are valid for 15 days and linked to prevailing diesel price.",
        "Payment within 30 days of delivery against a signed POD.",
        "Toll, parking, octroi and detention are charged at actuals.",
        "Transit insurance is to be arranged by the consignor unless quoted.",
      ],
    },
    relatedSlugs: [
...

  {
    ...
    seoTitle: 'Repair Service Quotation Maker – Free Appliance & AMC Quote Format',
    metaDescription:
...
For businesses running annual maintenance contracts (AMC) for ACs, industrial equipment, or office electronics, the tool also works well for structured yearly quotations covering a fixed number of service visits plus a defined rate for spare parts and emergency call-outs, which is the standard format corporate and residential AMC clients expect before signing a contract.`,
    ...
    sampleItems: [
      { description: 'Diagnostic and visiting charge', unit: 'per visit', hsn: '998719', qty: 1, rate: 450 },
      { description: 'AC gas refilling and leak testing', unit: 'per unit', hsn: '998719', qty: 2, rate: 2800 },
      { description: 'Spare part – compressor/PCB replacement', unit: 'per piece', hsn: '998719', qty: 1, rate: 8500 },
      { description: 'Labour and service charge', unit: 'per job', hsn: '998719', qty: 2, rate: 1200 },
      { description: 'Annual maintenance contract (4 visits/year)', unit: 'per year', hsn: '998719', qty: 1, rate: 4500 },
      { description: 'Emergency/out-of-hours service call', unit: 'per visit', hsn: '998719', qty: 1, rate: 900 },
    ],
    demo: {
      company: "CoolCare Appliance Services",
      address: "61, Brigade Road, Shanthala Nagar,\nBengaluru 560025",
      gstin: "29AAGCC4462E1ZJ",
      phone: "+91 99450 51170",
      email: "support@coolcareservices.in",
      clientName: "Shalini Rao",
      clientCompany: "Rao Apartments",
      clientAddress: "Flat 402, HSR Layout Sector 2,\nBengaluru 560102",
      note: "Spare parts carry a six-month warranty. Visiting charge waived if repair is approved.",
      terms: [
        "Estimate valid for 7 days from the date of inspection.",
        "Visiting charge is waived if the quoted repair is approved.",
        "Spare parts carry a six-month warranty from the date of fitting.",
        "Additional faults found during repair are quoted before proceeding.",
      ],
    },
    relatedSlugs: [
      'civil-contractor-quotation-maker',
